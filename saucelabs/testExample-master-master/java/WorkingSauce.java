...
// Task I
    /*WebElement element = driver.findElement(By.id("i am a link"));
    element.click();*/
// Task II
...
// Task III
    ...
    email.sendKeys("myemail@test.com");

    WebElement comments = driver.findElement(By.id("comments"));
    comments.sendKeys("This is so cool!");

    WebElement submitEmail = driver.findElement(By.id("submit"));
    submitEmail.click();
